...
var temp__4402__auto__ = cljs.core.deref.call(null,clojure.browser.repl.xpc_connection);
if(cljs.core.truth_(temp__4402__auto__)){
var conn = temp__4402__auto__;
...
var temp__4402__auto__ = clojure.browser.net.xpc_connection.call(null);
if(cljs.core.truth_(temp__4402__auto__)){
var repl_connection = temp__4402__auto__;
var connection = clojure.browser.net.xhr_connection.call(null);
clojure.browser.event.listen.call(null,connection,new cljs.core.Keyword(null,"success","success",1890645906),((function (connection,repl_connection,temp__4402__auto__){
return (function (e){
return clojure.browser.net.transmit.call(null,repl_connection,new cljs.core.Keyword(null,"evaluate-javascript","evaluate-javascript",-315749780),e.currentTarget.getResponseText(cljs.core.List.EMPTY));
});})(connection,repl_connection,temp__4402__auto__))
);

clojure.browser.net.register_service.call(null,repl_connection,new cljs.core.Keyword(null,"send-result","send-result",35388249),((function (connection,repl_connection,temp__4402__auto__){
...
clojure.browser.net.register_service.call(null,repl_connection,new cljs.core.Keyword(null,"print","print",1299562414),((function (connection,repl_connection,temp__4402__auto__){
return (function (data){
...
return setTimeout(((function (connection,repl_connection,temp__4402__auto__){
return (function (){
...
return (function (){
if(cljs.core.truth_((function (){var and__3239__auto__ = clojure.browser.repl.load_queue;
if(cljs.core.truth_(and__3239__auto__)){
...
var reload_QMARK_ = (function (){var or__3247__auto__ = reload;
