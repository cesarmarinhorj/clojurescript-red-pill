...
hello_world.core.ISayStuff = (function (){var obj33 = {};
return obj33;
})();
...
if(typeof hello_world.core.t37 !== 'undefined'){
} else {

/**
* @constructor
*/
hello_world.core.t37 = (function (reify_sayer,f_name,stuff,meta38){
...
hello_world.core.t37.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_39,meta38__$1){
var self__ = this;
var _39__$1 = this;
return (new hello_world.core.t37(self__.reify_sayer,self__.f_name,self__.stuff,meta38__$1));
});

hello_world.core.t37.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_39){
var self__ = this;
var _39__$1 = this;
return self__.meta38;
});

hello_world.core.t37.prototype.hello_world$core$ISayStuff$ = true;

hello_world.core.t37.prototype.hello_world$core$ISayStuff$say_hello$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
return window.alert(self__.f_name);
});

hello_world.core.t37.prototype.hello_world$core$ISayStuff$say_stuff$arity$2 = (function (_,___$1){
var self__ = this;
var ___$2 = this;
return window.alert(hello_world.core.format.call(null,"%s says %s",self__.f_name,self__.stuff));
});

hello_world.core.t37.cljs$lang$type = true;

hello_world.core.t37.cljs$lang$ctorStr = "hello-world.core/t37";

hello_world.core.t37.cljs$lang$ctorPrWriter = (function (this__3462__auto__,writer__3463__auto__,opt__3464__auto__){
return cljs.core._write.call(null,writer__3463__auto__,"hello-world.core/t37");
});

hello_world.core.__GT_t37 = (function hello_world$core$reify_sayer_$___GT_t37(reify_sayer__$1,f_name__$1,stuff__$1,meta38){
return (new hello_world.core.t37(reify_sayer__$1,f_name__$1,stuff__$1,meta38));
});

}

return (new hello_world.core.t37(hello_world$core$reify_sayer,f_name,stuff,cljs.core.PersistentArrayMap.EMPTY));
});
